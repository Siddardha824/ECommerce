...
<body class="bgcol">
    ...
    <div class="d-flex menu p-1">
        <div class="d-flex navg">
            <div>
                <a class="btn btn-success bagc" href="home.php">View Products</a>
            </div>
            <div>
                <a class="btn btn-success bagc" href="cart.php">My Cart</a>
            </div>
            <div>
                <a class="btn btn-success bagc" href="orders.php">My Orders</a>
            </div>
        </div>
        <?php
